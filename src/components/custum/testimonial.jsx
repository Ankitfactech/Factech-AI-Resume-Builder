const posts = [
  {
    id: 1,
    title: 'Application is Really Amazing',
    href: '#',
    description:
  ...
  {
    id: 2,
    title: 'It is quite easy to use , just loved it !!',
    href: '#',
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    date: 'Mar 16, 2020',
  ...
  {
    id: 3,
    title: ' I got my my first Job using Factech AI-Resume ',
    href: '#',
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    date: 'Mar 16, 2020',
    datetime: '2020-03-16',
    category: { title: 'Satisfied', href: '#' },
    author: {
      name: 'Ayush Rathore',
      role: 'Coder',
      href: '#',
